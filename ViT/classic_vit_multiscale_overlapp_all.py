...
from patch_embedding import PatchEmbedding, ImagePatcher, ImagePatcherOverlap
...
class MultiscaleViT(nn.Sequential):
    def __init__(self,     
        ...
        n_patches = (img_size//patch_size)**2 + (img_size//patch_size - 1)**2 + ((img_size//patch_size)*(img_size//patch_size-1))*2 
        super().__init__(
            ImagePatcherOverlap(in_channels, patch_size, img_size, returnGrouped=False),
            #ParallelScale(
                #Printer(),
