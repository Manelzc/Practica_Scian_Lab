...
# %%
train_set = torchvision.datasets.ImageFolder(root='C:/Users/Manel/Desktop/Practica2/git/CustomViT/plant-pathology-2020-fgvc7/images/Train', transform=transform)
    
test_set = torchvision.datasets.ImageFolder(root='C:/Users/Manel/Desktop/Practica2/git/CustomViT/plant-pathology-2020-fgvc7/images/Test', transform=transform) 
...
# %%
# Training loop
MODEL_PATH= "models/bestOverlapPlants.pth"
...
fig.savefig('plots/Plants101_overlap_losses-'+str(LR)+'.png')
