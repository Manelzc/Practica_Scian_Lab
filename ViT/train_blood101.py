...
# %%
train_set = torchvision.datasets.ImageFolder(root='C:/Users/Manel/Desktop/Practica2/git/CustomViT/blood-cells/dataset2-master/dataset2-master/images/TRAIN', transform=transform)
    
test_set = torchvision.datasets.ImageFolder(root='C:/Users/Manel/Desktop/Practica2/git/CustomViT/blood-cells/dataset2-master/dataset2-master/images/TEST', transform=transform)
...
# %%
# Training loop
MODEL_PATH= "models/bestNormalBlood.pth"
...
fig.savefig('plots/blood101_traditional_losses-'+str(LR)+'.png')
